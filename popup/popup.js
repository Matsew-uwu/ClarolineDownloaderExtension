chrome.tabs.query({ active: true, currentWindow: true }, async function (tabs) {
  ...
  if (!tab.url.includes('https://clarolineconnect.univ-lyon1.fr/')) {
    displayErrorPopup();
  } else {
    document.getElementById('instruction-text').innerHTML = "Sélectionner un fichier pour le visionner.";
...
const displayErrorPopup = () => {
  ...
  instruction.innerHTML = 'Cette extension fonctionne uniquement sur <a href="clarolineconnect.univ-lyon1.fr/">Claroline Connect</a>.';
};